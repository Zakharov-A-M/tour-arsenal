...
<meta property="og:title" content="Отзывы гостей - Туркомплекс "Арсенал"" />
						...
						О нас													<i class="fa fa-angle-right"></i>
									...
									<a href="../area/index.html" title="Территория">
										Территория																			</a>
																							...
																							<li class=" active">
									<a href="index.html" title="Отзывы гостей">
										Отзывы гостей																			</a>
																	</li>
													</ul>
									</li>
							...
							<a class="dropdown-toggle link_first" href="../index.html" title="О нас">
								...
								<ul class="dropdown-menu">
											...
											<a href="../area/index.html" title="Территория">Территория</a>
																													...
																													<li class=" active">
											<a href="index.html" title="Отзывы гостей">Отзывы гостей</a>
																					</li>
																	</ul>
													</div>
					</td>
	...
	var jsControl = new JCTitleSearch({
		...
		<ul class="nav nav-list side-menu">
					...
					<a href="../area/index.html">Территория</a>
							...
							<li class="active ">
					<a href="index.html">Отзывы гостей</a>
													</li>
					</ul>
	</aside>
										<div class="sidearea">
