...
<div class="menu-row row">
		...
		<ul class="nav nav-pills responsive-menu visible-xs" id="mainMenuF">
					...
					<a class="dropdown-toggle" href="../area" title="О нас">
						О нас													<i class="fa fa-angle-right"></i>
									...
									<a href="../" title="О нас">
										О нас																			</a>
																							...
																							<li class=" active">
									<a href="../area" title="Территория">
										Территория																			</a>
																	</li>
																							<li class=" ">
									<a href="../reviews" title="Отзывы гостей">
										Отзывы гостей																			</a>
																	</li>
													</ul>
									</li>
	...
	<div class="table-menu hidden-xs">
		<table>
			<tr>
						...
						<div class="wrap">
							<a class="dropdown-toggle link_first" href="../" title="О нас">
								...
								<ul class="dropdown-menu">
											...
											<a href="../" title="О нас">О нас</a>
																													...
																													<li class=" active">
											<a href="../area" title="Территория">Территория</a>
																					</li>
																													<li class=" ">
											<a href="../reviews" title="Отзывы гостей">Отзывы гостей</a>
																					</li>
																	</ul>
													</div>
					</td>
